...
import {validateFields, login} from './loginControl'
		...
		<form onSubmit={(e) => {validateFields()}} id="register-form">
			...
			<div className="form-group">
				...
				<input type="date" className="form-control" name="dob" id="dob"
				 placeholder="Your date of birth" required></input><br /><br />
			</div>
			<div className="form-group">
				<label>Zipcode:</label>
				<input type="text" className="form-control" name="zipcode" 
				id="zipcode" placeholder="Your zip code" required 
				pattern="[0-9]{5}"></input> <br /><br />
			</div>
			<div className="form-group">
				<label>Password</label>
				<input type="password" className="form-control" name="password" 
				id="password" placeholder="Your password" required></input> 
				<br /><br />
			</div>
			<div className="form-group">
