...
import {navToMain, navToLogin, navToProfile,
        changePageToMain, changePageToProfile, changePageToLogin} from './actions'
describe('Test the actions', () => {
    ...
    it('should navigate', (done)=>{
        const main = changePageToMain();
        expect(main.type).to.equal('toMain');
        const login = changePageToLogin();
        expect(login.type).to.equal('toLogin');
        const profile = changePageToProfile();
