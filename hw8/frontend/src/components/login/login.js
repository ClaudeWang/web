...
import {validateFields, login, register, googleLogin} from './loginControl'
...
const GoogleLogin = ({dispatch}) => {
	return (
		<div id="googleLogin">
			...
			id="googleSignIn-btn" onClick={
				r => {
					dispatch(googleLogin())
				}
			}>
  				<span className="fa fa-google" id="googleIcon"></span>
  				Sign in with Google
			</button>
		</div>
	)
...
const RegistrationSection = ({dispatch}) =>{
	...
	return (
		...
		<form onSubmit={(e) => {e.preventDefault(); 
			dispatch(register(password, password_conf, 
				dob, email, zipcode, username));}} id="register-form">
			<div className="form-group">
			<label>Account Name:</label>
			...
			<div className="form-group">
				...
				required pattern=".+@.+\..+" 
				ref={(input) => email = input}></input> <br /><br />
			</div>
			<div className="form-group">
			...
			<div className="form-group">
				...
				<input type="date" className="form-control" name="dob" id="dob"
				 ...
				 ref={(input) => dob = input}></input><br /><br />
			</div>
			<div className="form-group">
				<label>Zipcode:</label>
				...
				pattern="[0-9]{5}" 
				ref={(input) => zipcode = input}></input> <br /><br />
			</div>
			<div className="form-group">
				<label>Password</label>
				<input type="password" className="form-control" name="password" 
				id="password" placeholder="Your password" required 
				ref={(input) => password = input}></input> 
				<br /><br />
			</div>
			<div className="form-group">
				...
				required 
				ref={(input) => password_conf = input}></input> <br /><br />
