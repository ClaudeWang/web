...
import {clearPost, updateStatus, goToProfile, logOut, 
    updateHeadline} from './mainControl'
...
const MainPage = ({dispatch, avatar, headline, username, friendsInfo, 
    articles, keyword, warningTextPackage, uploadImage}) => {
    return (
        <div id="main-body">
            <div id="header-area">
...
const AddPostArea = ({dispatch, uploadImage}) => {
    let keyword;
    let textField;
    let image;
    let imageField;
            ...
            onClick={(e) => 
                {
                    ...
                    dispatch(addNewArticle(textField, uploadImage))
                    dispatch({image: null, type: "uploadImage"})
                }
            }>
                Add Post</button> <br/>
    ...
    return (
        <div className="card">
            ...
            <button className="btn btn-danger" 
                onClick={(e) => dispatch(unfollow(name))}>
                Unfollow
            </button>
        </div>
    )
...
export default connect((state) => {
    ...
    return {
        ...
        warningTextPackage,
        uploadImage: state.articles.uploadImage
    }
})(MainPage)
export {PostTable}