...
describe('Test Main Page add functionalities', () => {
    ...
    it("Remove the Follower user and verify following count "+ 
        "decreases by one/Add the 'Follower'" +
        "user and verify following count increases by one", (done) => {
        
        const dummyFriend = "Follower"
        let secondInitial;
        sleep(1000)
        .then(
    ...
    it("Search for special 'Only One Article Like This' " + 
        "article and verify author", (done) => {
