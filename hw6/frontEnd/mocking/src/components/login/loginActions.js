...
function registerUser(newUsername, newEmail, newZipcode, newPassword) {
	return (dispatch) => {
		...
		.then (r => dispatch(updateWarningText('success', 'A new user has been registered')))
	}
}
...
export {refresh, fetchFollowsList,fetchProfileArea ,initialVisit, updateUsername, 
	fetchField, fetchArticles, registerUser, updateFollowsAvatars, updateFollowsHeadlines}