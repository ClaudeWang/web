		       ...
		       <td className="col-sm-12">
	            <div className="card">
	                <div className="card-block">
	                    ...
	                    <br/><br/><br/>
                    	<Comments comments={articleInfo.comments} username={this.props.username} 
		...
		<div className="row">
	      <div className="col-xs-16">
	        <div className="input-group">
	            <input type="text" className="form-control" ref={r => commentContent = r}/>
	          <div className="input-group-btn">
	            <button type="submit" className="btn" 
	            onClick={(e) => {dispatch(addNewComment(commentContent, articleID))}}>Add Comment</button>
	          </div>
	        </div>
	      </div>
	    </div>
			...
			<div>
				...
				<br/></h5>
				{
					...
					(<div>
						...
						<button className="btn btn-primary"
							onClick={e=>editComment(commentContainer, articleId, comment.commentId)}>Save</button>
						<button className="btn btn-warning" 
							onClick={e=>commentContainer.innerHTML=comment.text}>Cancel</button>
					</div>):
					(comment.text)
				}
			</div>
